...
nav = st.navigation({
    ...
    "Daily workflow": [
        st.Page("pages/1_Defect_Register.py",
                title="2 · Defect Register", icon="🗺️"),
        st.Page("pages/2_Defect_Detail.py",
                title="3 · Defect Detail", icon="📋"),
        st.Page("pages/7_BIM_3D_Viewer.py",
                title="3D Tunnel (BIM)", icon="🧊"),
        st.Page("pages/8_Report.py", title="Report (PDF)", icon="📄"),
    ],
    "Add data": [
        st.Page("pages/0_Ingest.py", title="Ingest a finding", icon="📤"),
        st.Page("pages/6_Tunnel_Setup.py", title="Tunnel Setup", icon="🛠️"),
    ],
    "Verify (specialists)": [
